...
//go:generate swagger generate server --target ../../api --name Backend --spec ../../../swagger/swagger.yaml --principal interface{} --exclude-main
...
func configureAPI(api *operations.BackendAPI) http.Handler {
	...
	if api.PostPayedHandler == nil {
		api.PostPayedHandler = operations.PostPayedHandlerFunc(func(params operations.PostPayedParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.PostPayed has not yet been implemented")
		})
	}
